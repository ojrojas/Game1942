namespace Core.Objects.Enemies
{
    public class TurretSprite : BaseObjectGame
    {
        ...
        public event EventHandler<GamePlayStateEvents.TurretShoots> OnTurretShoots;
        ...
        public TurretSprite(Texture2D baseTexture, Texture2D cannonTexture, float moveSpeed)
        {
            ...
            AddBoundingBox(new Engine.ObjectGame.BoundingBox(new Vector2(0, 0), _baseTexture.Width * Scale, _baseTexture.Height * Scale));
        }
        ...
        public void Shoot(GameTime gameTime)
        {
            if (!_isShootingBullets && _bulletsRemaining > 0)
            {
                ...
                var bulletInfo = new GamePlayStateEvents.TurretShoots(bullet1Pos, bullet2Pos, _angle, _direction);
        ...
        public override void OnNotify(IBaseGameStateEvent gameEvent)
        {
            switch (gameEvent)
            {
