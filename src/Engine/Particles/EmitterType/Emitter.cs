namespace Engine.Particles
{
    public class Emitter : BaseObjectGame
    {
        ...
        public Emitter(Texture2D texture,
                       ...
                       int nbParticleEmittedPerUpdate,
                       int maxParticles)
        {
            _emitterParticleState = particleState ?? throw new ArgumentNullException(nameof(particleState));
            _emitterType = emitterType ?? throw new ArgumentNullException(nameof(particleState));
            _texture = texture ?? throw new ArgumentNullException(nameof(particleState));
